...
public final class AlertBuilder {
    ...
    func prsentT(addingDefaultAction: Bool = false, from view: UIViewController?, completion: (() -> ())? = nil) {
        guard let view = view else {
            return
        }
        self.present(addingDefaultAction: addingDefaultAction, from: view, completion: completion)
